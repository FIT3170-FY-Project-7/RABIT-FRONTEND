                ...
                {currentTab === 'all' && (
                    <List disablePadding component='div'>
                        <ListItemWrapper selected>
                            <ListItemAvatar>
                                <Avatar src='/public/static/images/avatars/1.jpg' />
                            </ListItemAvatar>
                            <ListItemText
                                sx={{ mr: 1 }}
                        ...
                        <ListItemWrapper>
                            <ListItemAvatar>
                                <Avatar src='/public/static/images/avatars/2.jpg' />
                            </ListItemAvatar>
                            <ListItemText
                                sx={{ mr: 1 }}
                                primaryTypographyProps={{
                        ...
                        <ListItemWrapper>
                            <ListItemAvatar>
                                <Avatar src='/public/static/images/avatars/4.jpg' />
                            </ListItemAvatar>
                            <ListItemText
                                sx={{ mr: 1 }}
                                primaryTypographyProps={{
                    ...
                    <AvatarGroup>
                        <Tooltip arrow title='View profile for Remy Sharp'>
                            <Avatar
                                ...
                                to='#'
                                alt='Remy Sharp'
                                src='/public/static/images/avatars/1.jpg'
                            />
                        </Tooltip>
                        <Tooltip arrow title='View profile for Travis Howard'>
                            <Avatar
                                ...
                                to='#'
                                alt='Travis Howard'
                                src='/public/static/images/avatars/2.jpg'
                            />
                        </Tooltip>
                    ...
                    <AvatarGroup>
                        ...
                        <Tooltip arrow title='View profile for Craig Vaccaro'>
                            <Avatar
                                ...
                                to='#'
                                alt='Craig Vaccaro'
                                src='/public/static/images/avatars/5.jpg'
                            />
                        </Tooltip>
                    </AvatarGroup>
