...
import PlotDownloadService from '../../content/plots/PlotDownload.service'
  ...
  return (
    <>
      ...
      <StyledMenu
        ...
        onClose={handleClose}
      >
        <MenuItem onClick={downloadCornerPlotPNG} disableRipple>
          <ImageIcon />
          PNG
        </MenuItem>
        <MenuItem onClick={downloadCornerPlotSVG} disableRipple>
          <PolylineIcon />
          SVG
        </MenuItem>
      </StyledMenu>
